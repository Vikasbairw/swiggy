...
axios.post("http://localhost:5000/user/singup",data).then(
    (success)=>{
      e.target.reset();
console.log(success);
    }
...
console.log(error);
  ...
  <div className="max-w-screen-xl m-0  bg-white shadow sm:rounded-lg flex justify-center flex-1 h-[100vh]">
    <div className="lg:w-1/2 xl:w-5/12 p-6 sm:p-11">
      
      <div className=" flex flex-col items-center">
        <h1 className="text-2xl xl:text-3xl pb-2 font-extrabold">Sign up</h1>
    ...
    <div className="flex-1 h-[100vh] bg-indigo-100 text-center hidden lg:flex">
      <div
        className=" xl:m-16 w-full bg-contain bg-center bg-no-repeat h-[100vh]">
          <img src="./images/vector2.png" alt="" className="h-[100vh]" />
        </div>
    </div>
  </div>
</div>
